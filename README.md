...
Huge thanks to NRCAN for access to their AWS mirror of Sentinel-2 products! According to a colleage, 13% of all public facing BCWS perimeter data were created from this source in 2023. The dominant/preferred method for active fire mapping is an airborne source that is based in Alberta and costs approx 30K CAD / day to fly. The NRCAN AWS mirror was used heavily in the unprecedented 2023 season, especially during a critical time when the airborne source was not available. 
